...
* "Coyote Space Industries" is trademark of [`dboi88`][dboi88]
* "CSI" is trademark of [`dboi88`][dboi88]
* "Coyote Cargo Freighter" is trademark of [`dboi88`][dboi88]
* "CCF" is trademark of [`dboi88`][dboi88]
...
* "Coyote Space Industries (CSI)" is a fictitious entity created for entertainment purposes. It is in no way meant to represent a real entity. Any similarity to a real entity is purely coincidental.
